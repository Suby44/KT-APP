...
const TRIMESTER_DESCRIPTIONS: Record<1 | 2 | 3, string> = {
  1: "Early days — your body is laying the groundwork for the months ahead.",
  2: "Often the most comfortable stretch — energy tends to pick back up.",
  3: "The home stretch — your body is getting ready to meet your baby.",
};
...
export function TodayPage() {
  ...
  return (
    <div>
      <PageHeader title="Today" subtitle={isPregnancy ? "Your pregnancy at a glance" : "Your cycle at a glance"} />
      ...
      <div className="space-y-4 px-5">
        ...
        <Card>
          <div className="flex items-center justify-between">
            ...
            <Button variant="secondary" className="!px-4 !py-2 !text-xs" onClick={() => setLogOpen(true)}>
          ...
          {todayLog && (todayLog.moods.length > 0 || todayLog.symptoms.length > 0 || todayLog.isPeriodDay) ? (
            ...
            <p className="mt-2 text-sm text-neutral-400">
              Nothing logged yet today — tap "Log today" to track your mood or symptoms.
            </p>
          )}
        </Card>
      </div>
